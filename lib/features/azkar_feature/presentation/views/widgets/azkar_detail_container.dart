                  ...
                  child: Column(
                    ...
                    Row(
                      children: [
                        ...
                        Spacer(),
                        CircleAvatar(backgroundColor: AppColors.darkPink,radius: 20,child: Text(widget.azkarItemEntity.id.toString(),style: AppTextStyles.titles.copyWith(color: AppColors.mainColor),),)
                      ],
                    ),
                    Text(
                    ...
                    CustomBtn(title: "${widget.azkarItemEntity.currCount}/${widget.azkarItemEntity.count}", onTap: () {  
                  setState(() {
                    
                        if(widget.azkarItemEntity.currCount<widget.azkarItemEntity.count){
                        widget.azkarItemEntity.currCount+=1;
                        
                      }
                      print("+++++++++++++++++++++++++++++${widget.azkarItemEntity.currCount}");
                  });
                    },)
                    ]),
                ),
